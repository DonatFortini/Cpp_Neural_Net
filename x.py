...
class NeuralNetwork:
    ...
    def forward(self, inputs):
        ...
        self.final_output = self.sigmoid(
    ...
    def train(self, inputs, targets, learning_rate, epochs):
        for epoch in range(epochs):
            for i in range(len(inputs)):
                ...
                print(
                    f"Epoch {epoch+1}/{epochs}, Sample {i+1}/{len(inputs)}, Loss: {loss:.6f}")
...
if __name__ == "__main__":
    ...
    for i in range(len(inputs)):
        ...
        print(
            f"Input: {input_data}, Target: {target_data}, Predicted: {predicted_output}")
